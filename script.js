...
// Chama a função para o primeiro botão// Função para alternar a visibilidade de um elemento
function toggleVisibility(buttonId, messageId) {
  const button = document.getElementById(buttonId);
  const message = document.getElementById(messageId);
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const dataReferencia = new Date("2025-06-24T10:12:00");
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const dataReferencia = new Date("2025-06-23T09:55:00");
