...
toggleVisibility('clickHere18', 'message18');

toggleVisibility('clickHere19', 'message19');

toggleVisibility('clickHere20', 'message20');

toggleVisibility('clickHere21', 'message21');

toggleVisibility('clickHere22', 'message22');

toggleVisibility('clickHere23', 'message23');

toggleVisibility('clickHere24', 'message24');

toggleVisibility('clickHere25', 'message25');

toggleVisibility('clickHere26', 'message26');

toggleVisibility('clickHere27', 'message27');

toggleVisibility('clickHere28', 'message28');

toggleVisibility('clickHere29', 'message29');

toggleVisibility('clickHere30', 'message30');

toggleVisibility('clickHere31', 'message31');

toggleVisibility('clickHere32', 'message32');

toggleVisibility('clickHere33', 'message33');

toggleVisibility('clickHere34', 'message34');

toggleVisibility('clickHere35', 'message35');
...
toggleVisibility('clickHere39', 'message39');

toggleVisibility('clickHere40', 'message40');

toggleVisibility('clickHere41', 'message41');

toggleVisibility('clickHere42', 'message42');

toggleVisibility('clickHere43', 'message43');

toggleVisibility('clickHere44', 'message44');

toggleVisibility('clickHere45', 'message45');

toggleVisibility('clickHere46', 'message46');

toggleVisibility('clickHere47', 'message47');

toggleVisibility('clickHere48', 'message48');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const dataReferencia = new Date("2025-06-30T10:11:00");
...
toggleVisibility('clickHere49', 'message49');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const dataReferencia = new Date("2025-07-01T23:30:00");
